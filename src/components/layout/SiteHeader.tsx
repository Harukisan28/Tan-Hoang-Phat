      ...
      <div className={styles.mainBar}>
        <div className="container">
          <div className={styles.mainBarInner}>
            <a className={styles.logoLink} href="/" aria-label="Tân Hoàng Phát - Trang chủ" onClick={(event) => { event.preventDefault(); handleNavigate('/'); }}>
              <img src="/assets/tan-hoang-phat-logo.jpeg" alt="Logo Tân Hoàng Phát" />
            </a>
            ...
            <a className={styles.desktopCta} href="/lien-he" onClick={(event) => { event.preventDefault(); handleNavigate('/lien-he'); }}>
              Nhận tư vấn
            </a>
            <button
              ref={menuButtonRef}
